    ...
    <div className="w-[970px] h-[470px] flex  bg-white justify-evenly items-center ">
      ...
      <div className="flex flex-col w-[500px]   gap-5">
        ...
        <div className=" text-base font-inter font-medium leading-7 text-gray-500">
          <h6>
            I build responsive, high-performance applications using React.js,
            focusing on UI/UX design. Passionate about continuous learning, I
        ...
        <a
          href="https://flowcv.com/resume/7tc85oode1"
          target="_blank"
          rel="noopener noreferrer"
     
        >
          <button className="mt-3 w-40 bg-yellow-400 p-3 text-xl font-semibold rounded-md  flex  justify-center items-center text-center gap-4">
